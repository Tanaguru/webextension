                ...
                if(mutation.removedNodes.length > 0 && mutation.addedNodes.length > 0) {
                    ...
                    for(let y = 0; y < newList.length; y++) {
                        if(mutation.addedNodes[y].nodeType === 1 || mutation.addedNodes[y].nodeType === 3) {
                            let afterData = mutation.addedNodes[y].nodeType == 1 ? mutation.addedNodes[y].outerHTML : mutation.addedNodes[y].data;
                    ...
                    for(let y = 0; y < oldList.length; y++) {
                        if(mutation.removedNodes[y].nodeType === 1 || mutation.removedNodes[y].nodeType === 3) {
                            let beforeData = mutation.removedNodes[y].nodeType == 1 ? mutation.removedNodes[y].outerHTML : mutation.removedNodes[y].data;
                    ...
                    if(!findMutation) {
                        if(mutation.removedNodes.length === 1 && mutation.addedNodes.length === 1) {
                            if((mutation.removedNodes[0].nodeType === 1 || mutation.removedNodes[0].nodeType === 3) && (mutation.addedNodes[0].nodeType === 1 || mutation.addedNodes[0].nodeType === 3)) {
                                let beforeData = mutation.removedNodes[0].nodeType == 1 ? mutation.removedNodes[0].outerHTML : mutation.removedNodes[0].data;
                                let afterData = mutation.addedNodes[0].nodeType == 1 ? mutation.addedNodes[0].outerHTML : mutation.addedNodes[0].data;
                    ...
                    if(mutation.addedNodes.length > 0) {
                        mutation.addedNodes.forEach(el => {
                            let afterData = el.nodeType == 1 ? el.outerHTML : el.data;
                            let mutationDetails = {
                                el: extractOnlyNode(currentEl),
                                type: 1,
                                desc: "Un noeud enfant a été ajouté.",
                        ...
                        mutation.removedNodes.forEach(el => {
                            let beforeData = el.nodeType == 1 ? el.outerHTML : el.data;
                            let mutationDetails = {
                                el: extractOnlyNode(currentEl),
                                type: 2,
                                desc: "Un noeud enfant a été supprimé.",
